...
test('loads data from yaml files', function () {
...
test('nested data file creates hierarchy', function () {
...
test('getDataPath strips dir prefix and extension', function () {
...
test('getDataPath preserves nested path', function () {
...
test('generatePageData merges data env and page', function () {
...
test('refresh reloads data', function () {
...
test('env data includes environment', function () {
    $this->createDataFile('data.yml', ['key' => 'value']);
...
test('multiple data files merge at root for default name', function () {
